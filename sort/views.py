...
def sort1(request):
    with open(r'C:\\output.csv', newline='', encoding='utf-8') as csvfile:
...
def sort2(request):
    with open(r'C:\\output.csv', newline='', encoding='utf-8') as csvfile:
        ...
        for row in rows:
            ...
            results.append(dict(content=content, date=date,
                           likes=likes, comments=comments, link=link))
            results.sort(key=lambda x: int(x["likes"]), reverse=True)
...
def sort3(request):
    with open(r'C:\\output.csv', newline='', encoding='utf-8') as csvfile:
        ...
        for row in rows:
            ...
            results.append(dict(content=content, date=date,
                           likes=likes, comments=comments, link=link))
            results.sort(key=lambda x: int(x["comments"]), reverse=True)
